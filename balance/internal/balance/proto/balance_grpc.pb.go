...
type BalanceServiceClient interface {
	...
	GetOperations(ctx context.Context, in *OperationsRequest, opts ...grpc.CallOption) (BalanceService_GetOperationsClient, error)
}
...
func (c *balanceServiceClient) CreateTransaction(ctx context.Context, in *TransactionRequest, opts ...grpc.CallOption) (*TransactionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/balanceService.balanceService/CreateTransaction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *balanceServiceClient) GetOperations(ctx context.Context, in *OperationsRequest, opts ...grpc.CallOption) (BalanceService_GetOperationsClient, error) {
	stream, err := c.cc.NewStream(ctx, &BalanceService_ServiceDesc.Streams[0], "/balanceService.balanceService/GetOperations", opts...)
	if err != nil {
		return nil, err
	}
	x := &balanceServiceGetOperationsClient{stream}
...
type BalanceService_GetOperationsClient interface {
	Recv() (*OperationsResponse, error)
	grpc.ClientStream
}

type balanceServiceGetOperationsClient struct {
	grpc.ClientStream
}

func (x *balanceServiceGetOperationsClient) Recv() (*OperationsResponse, error) {
	m := new(OperationsResponse)
...
type BalanceServiceServer interface {
	...
	/// Used to view the history of transactions
	GetOperations(*OperationsRequest, BalanceService_GetOperationsServer) error
...
func (UnimplementedBalanceServiceServer) GetOperations(*OperationsRequest, BalanceService_GetOperationsServer) error {
...
func _BalanceService_CreateTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/balanceService.balanceService/CreateTransaction",
	}
...
func _BalanceService_GetOperations_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(OperationsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(BalanceServiceServer).GetOperations(m, &balanceServiceGetOperationsServer{stream})
}

type BalanceService_GetOperationsServer interface {
	Send(*OperationsResponse) error
	grpc.ServerStream
}

type balanceServiceGetOperationsServer struct {
	grpc.ServerStream
}

func (x *balanceServiceGetOperationsServer) Send(m *OperationsResponse) error {
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _BalanceService_GetOperations_Handler,
			ServerStreams: true,
		},
	},
